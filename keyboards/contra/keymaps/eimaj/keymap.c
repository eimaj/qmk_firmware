...
[_LOWER] = {
  ...
  {_______,  KC_MS_WH_DOWN,   KC_MS_BTN2, KC_MS_UP,   KC_MS_BTN1,   _______,   _______,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_GRV},
  {_______, KC_MS_WH_UP,   KC_MS_LEFT,   KC_MS_DOWN,   KC_MS_RIGHT,  _______ ,  _______ ,  _______, _______, _______, KC_PIPE,  SFT_T(KC_ENT)},
