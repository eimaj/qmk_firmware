...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------------------------------------------------'
     */
    [_QWERTY] = {{KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC}, {ALL_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT}, {KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, SFT_T(KC_ENT)}, {FUNCTION, KC_LCTL, KC_LALT, KC_LGUI, LOWER, KC_SPC, SFT_T(KC_SPC), RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT}},
   ...
   */
    [_QWERNUX] = {
        ...
        {FUNCTION, KC_LGUI, KC_LALT, KC_LCTL, LOWER, SFT_T(KC_SPC), SFT_T(KC_SPC), RAISE, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT}},
   ...
   */
    [_LOWER] = {
      ...
      {_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_ROCKET, KC_BSLS, SFT_T(KC_ENT)},
   ...
   */
    [_RAISE] = {
      ...
      {_______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_GRV},
