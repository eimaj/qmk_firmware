...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    LAYOUT(
        ...
        LT3_TAB, KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
   ...
   */
    ...
    LAYOUT(/* Right */
           ...
           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, SFT_T(KC_ENT),
   ...
   */
    ...
    LAYOUT(/* Tab */
           ...
           _______, _______, _______, _______, _______, _______, _______, _______, KC_0, KC_DOT,     _______),
};
